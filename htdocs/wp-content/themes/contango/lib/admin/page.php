<div class="wrap contango-settings">
  ...
  <?php settings_errors( 'contango_options' ); ?>
  
  <div id="contango-pro-wrapper">
    <a href="http://designorbital.com/contango-pro/" class="button button-primary button-hero" target="_blank"><?php _e( 'Contango Pro Features', 'prana' ); ?></a>
  </div>
